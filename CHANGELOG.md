...
- Reduced the public flake to reproducible GritQL packaging and `lib.mkGrit`.

### Removed

- Removed the consumer policy, check, codemod, and pattern-test wrapper APIs. Consumer integrations now own those
  concerns.
- Removed the wrapper capability matrix and fixtures.
